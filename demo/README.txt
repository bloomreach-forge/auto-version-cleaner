...
After your project is set up, access the CMS at <http://localhost:8080/cms> and the site at <http://localhost:8080/versionhistorycleanerdemo>.
...
as com.bloomreach.forge.version-history-cleaner/version-history-cleaner-demo:1.0.0-SNAPSHOT
